...
import net.minecraft.tileentity.TileEntityYelliteBrewingStand;
...
public class BlockYelliteBrewingStand extends BlockContainer
{
    ...
    public BlockYelliteBrewingStand()
    {
        super(Material.IRON);
    ...
    {
        return I18n.translateToLocal("item.yellite_brewing_stand.name");
    }
    ...
    {
        return new TileEntityYelliteBrewingStand();
    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing heldItem, float side, float hitX, float hitY)
    {
        ...
        else
        {
            ...
            if (tileentity instanceof TileEntityYelliteBrewingStand)
            {
                playerIn.displayGUIChest((TileEntityYelliteBrewingStand)tileentity);
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        if (stack.hasDisplayName())
        {
            ...
            if (tileentity instanceof TileEntityYelliteBrewingStand)
            {
                ((TileEntityYelliteBrewingStand)tileentity).setName(stack.getDisplayName());
            }
        }
    }
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        if (tileentity instanceof TileEntityYelliteBrewingStand)
        {
            InventoryHelper.dropInventoryItems(worldIn, pos, (TileEntityYelliteBrewingStand)tileentity);
        }
    ...
    {
        return Items.YELLITE_BREWING_STAND;
    }

    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
    {
        return new ItemStack(Items.YELLITE_BREWING_STAND);
    }
