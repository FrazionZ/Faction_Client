...
public class BlockZDirtChest extends BlockContainer
{
    public static final PropertyDirection FACING = BlockHorizontal.FACING;
    protected static final AxisAlignedBB NOT_CONNECTED_AABB = new AxisAlignedBB(0.0625D, 0.0D, 0.0625D, 0.9375D, 0.875D, 0.9375D);

    public BlockZDirtChest()
    {
        super(Material.WOOD);
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        if (stack.hasDisplayName())
        {
            ...
            {
                ((TileEntityDirtChest)tileentity).func_190575_a(stack.getDisplayName());
            }
        }
    }
    ...
    public ILockableContainer getContainer(World p_189418_1_, BlockPos p_189418_2_, boolean p_189418_3_)
    {
        ...
        {
            ILockableContainer ilockablecontainer = (TileEntityDirtChest)tileentity;
