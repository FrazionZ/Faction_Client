...
public class BlockZHopper extends BlockContainer
{
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing heldItem, float side, float hitX, float hitY)
    {
        ...
        else
        {
            ...
            if (tileentity instanceof TileEntityZHopper)
            {
                playerIn.displayGUIChest((TileEntityZHopper)tileentity);
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        if (tileentity instanceof TileEntityZHopper)
        {
            InventoryHelper.dropInventoryItems(worldIn, pos, (TileEntityZHopper)tileentity);
