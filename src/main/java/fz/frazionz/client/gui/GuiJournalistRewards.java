...
public class GuiJournalistRewards extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawTopList();
        //drawBackgroundItem(ItemUtils.getItemByText("frazion"), 1,this.width / 2 - 160, this.guiTop + this.ySize - 160);
        //drawBackgroundItemCurrent(ItemUtils.getItemByText("diamond"), 2, this.width / 2 - 35, this.guiTop + this.ySize - 165);
        //ddrawBackgroundItem(ItemUtils.getItemByText("bauxite_sword"),3,this.width / 2 + 100, this.guiTop + this.ySize - 160);
