...
public class GuiYelliteBrewingStand extends GuiContainer
{
    ...
    public GuiYelliteBrewingStand(InventoryPlayer playerInv, IInventory p_i45506_2_)
    {
        super(new ContainerYelliteBrewingStand(playerInv, p_i45506_2_));
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
    {
        ...
        this.fontRenderer.drawString(p, 11, this.ySize - 118 + 2, 16777067, true);
    }
