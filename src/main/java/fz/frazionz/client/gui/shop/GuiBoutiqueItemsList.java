...
public class GuiBoutiqueItemsList extends GuiListFrazionZInterface
{
    ...
    public GuiBoutiqueItemsList(GuiScreen lastScreen, ShopType type, Minecraft mcIn, int left, int right, int top, int bottom, int slotHeight)
    {
    ...
    {
    	ShopItem item = ((GuiBoutiqueItemsList.BoutiqueEntry)this.listEntries[slotIndex]).getBoutiqueItem();
    ...
    public class BoutiqueEntry implements GuiListExtended.IGuiListEntry
    {
        ...
        private BoutiqueEntry(ShopItem item)
        {
            this.item = item;
        ...
        public ShopItem getBoutiqueItem() {
			return this.item;
		}
