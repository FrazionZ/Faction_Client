...
{
    private static final DataParameter<Integer> FUSE = EntityDataManager.<Integer>createKey(EntityZTNTPrimed.class, DataSerializers.VARINT);
    @Nullable
    ...
    public EntityZTNTPrimed(World worldIn)
    {
        super(worldIn);
        this.fuse = 80;
    ...
    public EntityZTNTPrimed(World worldIn, double x, double y, double z, EntityLivingBase igniter)
    {
        this(worldIn);
