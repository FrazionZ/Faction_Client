...
public class FzGuiQuitButton extends Gui
{
    protected static final ResourceLocation BUTTON_TEXTURES = new ResourceLocation("textures/gui/fz_quit.png");
    ...
    public FzGuiQuitButton(int buttonId, int x, int y, String buttonText)
    {
        this(buttonId, x, y, 177, 36, buttonText);
    }

    public FzGuiQuitButton(int buttonId, int x, int y, int widthIn, int heightIn, String buttonText)
    {
        this.width = 177;
        this.height = 36;
        this.enabled = true;
