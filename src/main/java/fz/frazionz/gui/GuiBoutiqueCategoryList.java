...
public class GuiBoutiqueCategoryList extends GuiListExtended
{
    ...
    public GuiBoutiqueCategoryList(GuiScreen lastScreen, Minecraft mcIn, int left, int right, int top, int bottom, int slotHeight, int spaceBetween)
    {
        ...
        for (BoutiqueType boutiqueType : ShopAPIDataStocker.boutiqueTypes)
        {
    ...
    {
    	BoutiqueType type = ((GuiBoutiqueCategoryList.BoutiqueTypeEntry)this.listEntries[slotIndex]).getBoutiqueType();
    ...
    {
        private final BoutiqueType boutiqueType;
        ...
        private BoutiqueTypeEntry(BoutiqueType type)
        {
        ...
        public void func_192634_a(int p_192634_1_, int p_192634_2_, int p_192634_3_, int p_192634_4_, int p_192634_5_, int p_192634_6_, int p_192634_7_, boolean p_192634_8_, float p_192634_9_)
        {
            ...
            this.shopTypeButton.func_191745_a(GuiBoutiqueCategoryList.this.mc, p_192634_6_, p_192634_7_, p_192634_9_);
        }
