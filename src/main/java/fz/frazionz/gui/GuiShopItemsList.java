...
public class GuiShopItemsList extends GuiListExtended
{
    ...
    public GuiShopItemsList(GuiScreen lastScreen, ShopType type, Minecraft mcIn, int left, int right, int top, int bottom, int slotHeight, int spaceBetween)
    {
    ...
    public class ShopEntry implements GuiListExtended.IGuiListEntry
    {
        ...
        private ShopEntry(ShopItem item)
        {
            ...
            this.shopItemButton = new GuiShopItemButton(itemStack, "\u00A7f" + itemStack.getDisplayName(), Double.toString(this.item.getActualBuyPrice()) + "\u00A72$\u00A7r / " + Double.toString(this.item.getActualSellPrice()) + "\u00A74$\u00A7r", 0, 0, 0, 299, 36, 0, 239, this.background);
        }
        ...
        public void func_192634_a(int p_192634_1_, int p_192634_2_, int p_192634_3_, int p_192634_4_, int p_192634_5_, int p_192634_6_, int p_192634_7_, boolean p_192634_8_, float p_192634_9_)
        {
            ...
            this.shopItemButton.func_191745_a(GuiShopItemsList.this.mc, p_192634_6_, p_192634_7_, p_192634_9_);
        }
