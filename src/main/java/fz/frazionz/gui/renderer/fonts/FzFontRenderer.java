package fz.frazionz.gui.renderer.fonts;
 ...
 * @see Font 
 */
public final class FzFontRenderer extends Font {
     ...
     */
    public FzFontRenderer(ResourceLocation resourceLocation, float size) {
        super(resourceLocation, size);

        this.setupMinecraftColorCodes();
        this.setupBoldItalicIDs();
        
        //this.exportTexture("D:\\FRAZIONZ SERVER\\CODE MCP\\textures\\gui\\frazionz\\font\\");
    }
            ...
            for (int i = 0; i < size; i++) {
                ...
                if ((character == COLOR_CODE_START) && (i < size)) {
                    ...
                    if (colorIndex < 16) {
                        ...
                        GlStateManager.color((cc >> 16 & 0xFF) / 255.0F, (cc >> 8 & 0xFF) / 255.0F,
     ...
     */
    public void exportTexture(String folder) {
    	File outputfile = new File(folder + "font_" + this.getSize() +".png");
    	try {
			ImageIO.write(this.tex.getBufferImage(), "png", outputfile);
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
