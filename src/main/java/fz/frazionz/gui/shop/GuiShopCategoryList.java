...
public class GuiShopCategoryList extends GuiListFrazionZInterface
{
    ...
    public GuiShopCategoryList(GuiScreen lastScreen, Minecraft mcIn, int left, int right, int top, int bottom, int slotHeight)
    {
        ...
        int i = 0;
        for (MarketType shopType : ShopAPIDataStocker.shopTypes)
        {
    ...
    {
    	MarketType type = ((GuiShopCategoryList.ShopTypeEntry)this.listEntries[slotIndex]).getShopType();
    ...
    {
        private final MarketType shopType;
        ...
        private ShopTypeEntry(MarketType type)
        {
            this.shopType = type;
