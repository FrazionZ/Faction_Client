...
public class ContainerBauxiteFurnace extends Container
{
    ...
    public ContainerBauxiteFurnace(InventoryPlayer playerInventory, IInventory furnaceInventory)
    {
        this.tileFurnace = furnaceInventory;
        this.addSlotToContainer(new Slot(furnaceInventory, 0, 26, 14));
        this.addSlotToContainer(new Slot(furnaceInventory, 1, 44, 14));
        this.addSlotToContainer(new Slot(furnaceInventory, 2, 62, 14));
        this.addSlotToContainer(new SlotFurnaceFuel(furnaceInventory, 3, 44, 50));
        this.addSlotToContainer(new SlotZFurnaceOutput(playerInventory.player, furnaceInventory, 4, 107, 32));
        this.addSlotToContainer(new SlotZFurnaceOutput(playerInventory.player, furnaceInventory, 5, 125, 32));
        this.addSlotToContainer(new SlotZFurnaceOutput(playerInventory.player, furnaceInventory, 6, 143, 32));
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            else if (index != 2 && index != 0 && index != 1 && index != 3)
            {
                ...
                else if (TileEntityBauxiteFurnace.isItemFuel(itemstack1))
                {
