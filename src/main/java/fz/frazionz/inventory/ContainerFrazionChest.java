...
public class ContainerFrazionChest extends Container
{
    ...
    public ContainerFrazionChest(IInventory playerInventory, IInventory chestInventory, EntityPlayer player)
    {
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (!this.mergeItemStack(itemstack1, this.numRows * 18, this.inventorySlots.size(), false))
                {
