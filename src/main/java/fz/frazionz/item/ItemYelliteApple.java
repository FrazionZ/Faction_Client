...
{
    public ItemYelliteApple(int amount, float saturation, boolean isWolfFood)
    {
    ...
    protected void onFoodEaten(ItemStack stack, World worldIn, EntityPlayer player)
    {
        if (!worldIn.isRemote)
        {
                ...
                player.addPotionEffect(new PotionEffect(MobEffects.HEALTH_BOOST, 24000, 0));
        }
    }
    ...
    public void addInformation(ItemStack stack, World playerIn, List<String> tooltip, ITooltipFlag advanced) {
    	...
    	tooltip.add(" ");
    	tooltip.add("\u00A76\u00bb \u00A7eRegeneration 1 : 30s");
    	tooltip.add("\u00A76\u00bb \u00A7eResistance 1 : 2m30s");
    	tooltip.add("\u00A76\u00bb \u00A7eFire Resistance 1 : 2m30s");
    	tooltip.add("\u00A76\u00bb \u00A7e2 Coeur supplémentaire : 20mins");
    	tooltip.add(" ");
