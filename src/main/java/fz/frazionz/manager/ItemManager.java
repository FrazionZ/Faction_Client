...
import fz.frazionz.item.ItemEndermanTrophy;
...
public class ItemManager {
	...
	public static void registerItems() {
        ...
        registerItem(1250, "trophy_bat", (new ItemEndermanTrophy()).setFull3D().setTranslationKey("trophy_bat"));
        registerItem(1251, "trophy_blaze", (new ItemEndermanTrophy()).setFull3D().setTranslationKey("trophy_blaze"));
        registerItem(1252, "trophy_creeper", (new ItemEndermanTrophy()).setFull3D().setTranslationKey("trophy_creeper"));
        registerItem(1253, "trophy_enderman", (new ItemEndermanTrophy()).setFull3D().setTranslationKey("trophy_enderman"));
        registerItem(1254, "trophy_ghast", (new ItemEndermanTrophy()).setFull3D().setTranslationKey("trophy_ghast"));
        registerItem(1255, "trophy_guardian", (new ItemEndermanTrophy()).setFull3D().setTranslationKey("trophy_guardian"));
        registerItem(1256, "trophy_villager", (new ItemEndermanTrophy()).setFull3D().setTranslationKey("trophy_villager"));
        registerItem(1257, "trophy_shulker", (new ItemShulkerTrophy()).setFull3D().setTranslationKey("trophy_shulker"));
        registerItem(1258, "trophy_spider", (new ItemEndermanTrophy()).setFull3D().setTranslationKey("trophy_spider"));
        registerItem(1259, "trophy_skeleton", (new ItemSkeletonTrophy()).setFull3D().setTranslationKey("trophy_skeleton"));
        registerItem(1260, "trophy_slime", (new ItemEndermanTrophy()).setFull3D().setTranslationKey("trophy_slime"));
        registerItem(1261, "trophy_squid", (new ItemEndermanTrophy()).setFull3D().setTranslationKey("trophy_squid"));
        registerItem(1262, "trophy_pig", (new ItemEndermanTrophy()).setFull3D().setTranslationKey("trophy_pig"));
        registerItem(1263, "trophy_sheep", (new ItemSkeletonTrophy()).setFull3D().setTranslationKey("trophy_sheep"));
        registerItem(1264, "trophy_iron_golem", (new ItemEndermanTrophy()).setFull3D().setTranslationKey("trophy_iron_golem"));
        registerItem(1265, "trophy_silverfish", (new ItemEndermanTrophy()).setFull3D().setTranslationKey("trophy_silverfish"));
