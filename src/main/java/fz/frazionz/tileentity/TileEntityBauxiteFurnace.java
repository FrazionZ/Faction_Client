...
public class TileEntityBauxiteFurnace extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    private NonNullList<ItemStack> furnaceItemStacks = NonNullList.<ItemStack>withSize(7, ItemStack.EMPTY);
    ...
    public void update()
    {
        ...
        if (!this.world.isRemote)
        {
            ...
            if ((this.isBurning() || (!itemstack.isEmpty() && !((ItemStack)this.furnaceItemStacks.get(0)).isEmpty()) || ( !itemstack.isEmpty() && !((ItemStack)this.furnaceItemStacks.get(1)).isEmpty()) || ( !itemstack.isEmpty() && !((ItemStack)this.furnaceItemStacks.get(2)).isEmpty())))
            {
                    ...
                    if (this.isBurning())
                    {
                        ...
                        if (!itemstack.isEmpty())
                        {
                            ...
                            if (itemstack.isEmpty())
                            {
                                ...
                                this.furnaceItemStacks.set(3, item1 == null ? ItemStack.EMPTY : new ItemStack(item1));
                            }
                        }
                    }
                }
    ...
    {
        if (((ItemStack)this.furnaceItemStacks.get(0)).isEmpty() && ((ItemStack)this.furnaceItemStacks.get(1)).isEmpty() && ((ItemStack)this.furnaceItemStacks.get(2)).isEmpty())
        {
            return false;
        }
        else
