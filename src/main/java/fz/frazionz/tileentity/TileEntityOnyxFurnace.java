...
import fz.frazionz.inventory.ContainerOnyxFurnace;
...
public class TileEntityOnyxFurnace extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    public void update()
    {
        ...
        if (!this.world.isRemote)
        {
            ...
            if ((this.isBurning() || (!itemstack.isEmpty() && !((ItemStack)this.furnaceItemStacks.get(0)).isEmpty()) || ( !itemstack.isEmpty() && !((ItemStack)this.furnaceItemStacks.get(1)).isEmpty()) || ( !itemstack.isEmpty() && !((ItemStack)this.furnaceItemStacks.get(2)).isEmpty()) || ( !itemstack.isEmpty() && !((ItemStack)this.furnaceItemStacks.get(3)).isEmpty()) ))
            {
                    ...
                    if (this.isBurning())
                    {
                        ...
                        if (!itemstack.isEmpty())
                        {
                            ...
                            if (itemstack.isEmpty())
                            {
                                ...
                                this.furnaceItemStacks.set(4, item1 == null ? ItemStack.EMPTY : new ItemStack(item1));
                            }
                        }
                    }
                }
    ...
    private boolean canSmelt()
    {
        ...
        else
        {
            ...
            if (itemstack.isEmpty()  && itemstackA.isEmpty() && itemstackB.isEmpty() && itemstackC.isEmpty())
            {
                return false;
            }
            else
