...
import fz.frazionz.inventory.ContainerZFurnace;
...
public class TileEntityZFurnace extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    public void update()
    {
        ...
        if (!this.world.isRemote)
        {
            ...
            if ((this.isBurning() || (!itemstack.isEmpty() && !((ItemStack)this.furnaceItemStacks.get(0)).isEmpty()) || ( !itemstack.isEmpty() && !((ItemStack)this.furnaceItemStacks.get(1)).isEmpty())))
            {
                    ...
                    if (this.isBurning())
                    {
                        ...
                        if (!itemstack.isEmpty())
                        {
                            ...
                            if (itemstack.isEmpty())
                            {
                                ...
                                this.furnaceItemStacks.set(2, item1 == null ? ItemStack.EMPTY : new ItemStack(item1));
                            }
                        }
                    }
                }
