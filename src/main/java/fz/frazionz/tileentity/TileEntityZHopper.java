...
import fz.frazionz.inventory.ContainerZHopper;
...
public class TileEntityZHopper extends TileEntityLockableLoot implements IHopper, ITickable
{
    ...
    {
        return this.hasCustomName() ? this.customName : "container.z_hopper";
    }
    ...
    public static List<EntityItem> getCaptureItems(World worldIn, double p_181556_1_, double p_181556_3_, double p_181556_5_) // WEST - BAS - NORD || EST - HAUTEUR - SUD //
    {
        return worldIn.<EntityItem>getEntitiesWithinAABB(EntityItem.class, new AxisAlignedBB(p_181556_1_ - 4.5D, p_181556_3_ - 1.0D, p_181556_5_ - 4.5D, p_181556_1_ + 4.5D, p_181556_3_ + 4.5D, p_181556_5_ + 4.5D), EntitySelectors.IS_ALIVE);
    }
    /**
