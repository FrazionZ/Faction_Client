...
public abstract class FzTabCompleter
{
    /** The {@link GuiTextField} that is backing this {@link FzTabCompleter} */
    ...
    public FzTabCompleter(GuiChatTextField textFieldIn, boolean hasTargetBlockIn)
    {
