...
public class BlockPistonBase extends BlockDirectional
{
    ...
    public static boolean canPush(IBlockState blockStateIn, World worldIn, BlockPos pos, EnumFacing facing, boolean destroyBlocks, EnumFacing p_185646_5_)
    {
        ...
        if (block == Blocks.WITHER_BLOCK || block == Blocks.COMPACT_COBBLESTONE_X3 || block == Blocks.COMPACT_COBBLESTONE_X4 || block == Blocks.COMPACT_COBBLESTONE_X5 || block == Blocks.OBSIDIAN || block == Blocks.MELON_BLOCK || block == Blocks.LIT_PUMPKIN || block == Blocks.PUMPKIN || block == Blocks.REEDS || block == Blocks.OBSIDIAN_YELLITE || block == Blocks.OBSIDIAN_BAUXITE || block == Blocks.OBSIDIAN_ONYX || block == Blocks.OBSIDIAN_FRAZION)
        {
            return false;
        }
