...
import fz.frazionz.client.gui.inventory.GuiAmeliorator;
import fz.frazionz.client.gui.inventory.GuiBauxiteBrewingStand;
import fz.frazionz.client.gui.inventory.GuiBauxiteChest;
import fz.frazionz.client.gui.inventory.GuiBauxiteFurnace;
import fz.frazionz.client.gui.inventory.GuiDirtChest;
import fz.frazionz.client.gui.inventory.GuiFrazionChest;
import fz.frazionz.client.gui.inventory.GuiFrazionFurnace;
import fz.frazionz.client.gui.inventory.GuiHdvChest;
import fz.frazionz.client.gui.inventory.GuiItemCrusher;
import fz.frazionz.client.gui.inventory.GuiOnyxChest;
import fz.frazionz.client.gui.inventory.GuiOnyxFurnace;
import fz.frazionz.client.gui.inventory.GuiSpawnerInventory;
import fz.frazionz.client.gui.inventory.GuiTrophyForge;
import fz.frazionz.client.gui.inventory.GuiYelliteBrewingStand;
import fz.frazionz.client.gui.inventory.GuiYelliteChest;
import fz.frazionz.client.gui.inventory.GuiYelliteFurnace;
import fz.frazionz.client.gui.inventory.GuiZHopper;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void displayGUIChest(IInventory chestInventory)
    {
        ...
        else if ("minecraft:dirt_chest".equals(s))
        {
            this.mc.displayGuiScreen(new GuiDirtChest(this.inventory, chestInventory));
        }
        else if ("minecraft:yellite_chest".equals(s))
        {
            this.mc.displayGuiScreen(new GuiYelliteChest(this.inventory, chestInventory));
        }
        else if ("minecraft:bauxite_chest".equals(s))
        {
            this.mc.displayGuiScreen(new GuiBauxiteChest(this.inventory, chestInventory));
        }
        else if ("minecraft:frazion_chest".equals(s))
        {
            this.mc.displayGuiScreen(new GuiFrazionChest(this.inventory, chestInventory));
        }
        else if ("minecraft:hdv_chest".equals(s))
        {
            this.mc.displayGuiScreen(new GuiHdvChest(this.inventory, chestInventory));
        }
        else if ("minecraft:onyx_chest".equals(s))
        {
            this.mc.displayGuiScreen(new GuiOnyxChest(this.inventory, chestInventory));
        }
        else if ("minecraft:hopper".equals(s))
        {
            this.mc.displayGuiScreen(new GuiHopper(this.inventory, chestInventory));
        }
        else if ("minecraft:z_hopper".equals(s))
        {
            this.mc.displayGuiScreen(new GuiZHopper(this.inventory, chestInventory));
        }
        else if ("minecraft:furnace".equals(s))
        {
            this.mc.displayGuiScreen(new GuiFurnace(this.inventory, chestInventory));
        }
        else if ("minecraft:yellite_furnace".equals(s))
        {
            this.mc.displayGuiScreen(new GuiYelliteFurnace(this.inventory, chestInventory));
        }
        else if ("minecraft:bauxite_furnace".equals(s))
        {
            this.mc.displayGuiScreen(new GuiBauxiteFurnace(this.inventory, chestInventory));
        }
        else if ("minecraft:onyx_furnace".equals(s))
        {
            this.mc.displayGuiScreen(new GuiOnyxFurnace(this.inventory, chestInventory));
        }
        else if ("minecraft:frazion_furnace".equals(s))
        {
            this.mc.displayGuiScreen(new GuiFrazionFurnace(this.inventory, chestInventory));
        }
        else if ("minecraft:brewing_stand".equals(s))
        {
            this.mc.displayGuiScreen(new GuiBrewingStand(this.inventory, chestInventory));
        }
        else if ("minecraft:yellite_brewing_stand".equals(s))
        {
            this.mc.displayGuiScreen(new GuiYelliteBrewingStand(this.inventory, chestInventory));
        }
        else if ("minecraft:bauxite_brewing_stand".equals(s))
        {
        ...
        else if ("frazionz:trophy_forge".equals(s))
        {
