...
{
    private final GuiKeyBinds controlsScreen;
    private final Minecraft mc;
    private final GuiListExtended.IGuiListEntry[] listEntries;
    private int maxListLabelWidth;

    public GuiKeyBindingList(GuiKeyBinds controls, Minecraft mcIn)
    {
        this(controls, mcIn, 0, controls.width, controls.height/8, controls.height - controls.height/8, 20);
    }
    
    public GuiKeyBindingList(GuiKeyBinds controls, Minecraft mcIn, int left, int right, int top, int bottom, int slotHeight)
    {
    ...
    public class CategoryEntry implements GuiListExtended.IGuiListEntry
    {
        ...
        {
            GuiKeyBindingList.this.mc.fontRenderer.drawString(this.labelText, GuiKeyBindingList.this.left + (GuiKeyBindingList.this.right - GuiKeyBindingList.this.left)/2 - this.labelWidth / 2, y + slotHeight - GuiKeyBindingList.this.mc.fontRenderer.FONT_HEIGHT - 1, 16777215);
        }
