...
public abstract class GuiListExtended extends GuiSlot
{
    ...
    public GuiListExtended(Minecraft mcIn, int left, int right, int topIn, int bottomIn, int slotHeightIn, boolean second)
    {
        super(mcIn, left, right, topIn, bottomIn, slotHeightIn, second);
    }
    
    public GuiListExtended(Minecraft mcIn, int left, int right, int topIn, int bottomIn, int slotHeightIn, boolean second, int spaceBetween)
    {
        super(mcIn, left, right, topIn, bottomIn, slotHeightIn, second);
    }
