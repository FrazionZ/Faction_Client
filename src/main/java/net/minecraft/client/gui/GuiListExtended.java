...
{
    public GuiListExtended(Minecraft mcIn, int left, int right, int topIn, int bottomIn, int slotHeightIn)
    {
        super(mcIn, left, right, topIn, bottomIn, slotHeightIn);
    }
    public GuiListExtended(Minecraft mcIn, int left, int right, int topIn, int bottomIn, int slotHeightIn, int spaceBetween)
    {
        super(mcIn, left, right, topIn, bottomIn, slotHeightIn);
    }
