...
public class GuiListWorldSelection extends GuiListExtended
{
    ...
    public GuiListWorldSelection(GuiWorldSelection p_i46590_1_, Minecraft clientIn, int left, int right, int topIn, int bottomIn, int slotHeightIn)
    {
        super(clientIn, left, right, topIn, bottomIn, slotHeightIn);
