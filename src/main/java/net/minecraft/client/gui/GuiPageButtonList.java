...
public class GuiPageButtonList extends GuiListExtended
{
    ...
    public GuiPageButtonList(Minecraft mcIn, int left, int right, int topIn, int bottomIn, int slotHeightIn, GuiPageButtonList.GuiResponder p_i45536_7_, GuiPageButtonList.GuiListEntry[]... p_i45536_8_)
    {
