...
public class GuiRoundedTextField extends GuiTextField
{
    ...
    public GuiRoundedTextField(int buttonId, int x, int y, int widthIn, int heightIn, String buttonText, FontRenderer fontrendererObj)
    {
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            if (this.getEnableBackgroundDrawing())
            {
                ...
                this.fontRendererInstance.drawStringWithShadow(this.textBefore, this.xPosition, this.yPosition + (this.height/2) - 4, 0xFFFFFFFF);
            }
