...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    protected List<FzGuiRejoindreButton> rejoindreButtonList = Lists.<FzGuiRejoindreButton>newArrayList();
    protected List<FzGuiOptionButton> optionButtonList = Lists.<FzGuiOptionButton>newArrayList();
    protected List<FzGuiQuitButton> quitButtonList = Lists.<FzGuiQuitButton>newArrayList();
    ...
    public void drawHoveringText(List<String> textLines, int x, int y)
    {
        if (!textLines.isEmpty())
        {
            ...
            background = new Color(13, 13, 13, 220);
            
            this.zLevel = 300.0F;
            this.itemRender.zLevel = 300.0F;
            int l = -267386864;
            this.drawGradientRect(l1 - 4, i2 - 4, l1 + i + 4, i2 - 3, Color.LIGHT_GRAY.getRGB(), Color.LIGHT_GRAY.getRGB());
            this.drawGradientRect(l1 - 4, i2 + k + 3, l1 + i + 4, i2 + k + 4, Color.LIGHT_GRAY.getRGB(), Color.LIGHT_GRAY.getRGB());
            this.drawGradientRect(l1 - 3, i2 - 3, l1 + i + 3, i2 + k + 3, background.getRGB(), background.getRGB());
            this.drawGradientRect(l1 - 4, i2 - 3, l1 - 3, i2 + k + 3, Color.LIGHT_GRAY.getRGB(), Color.LIGHT_GRAY.getRGB());
            this.drawGradientRect(l1 + i + 3, i2 - 3, l1 + i + 4, i2 + k + 3, Color.LIGHT_GRAY.getRGB(), Color.LIGHT_GRAY.getRGB());
            int i1 = 1347420415;
            int j1 = 1344798847;
    ...
    protected void actionRejoindre(FzGuiRejoindreButton button) throws IOException
    {
    }

    protected void actionQuit(FzGuiQuitButton button) throws IOException
    {
    }

    protected void actionOption(FzGuiOptionButton button) throws IOException
    {
    }
    ...
    public void setWorldAndResolution(Minecraft mc, int width, int height)
    {
        ...
        this.rejoindreButtonList.clear();
        this.optionButtonList.clear();
        this.quitButtonList.clear();
        this.initGui();
    }
    ...
    public void drawBackground(int tint)
    {
        ...
        this.mc.getTextureManager().bindTexture(FZ_OPTIONS_BACKGROUND);
        ...
        tessellator.draw();*/
        mc.getTextureManager().bindTexture(FZ_OPTIONS_BACKGROUND);
        GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
