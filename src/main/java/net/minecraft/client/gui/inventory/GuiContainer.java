...
public abstract class GuiContainer extends GuiScreen
{
    ...
    public static final ResourceLocation NEW_INVENTORY_BACKGROUND = new ResourceLocation("textures/gui/frazionz/container/inventory.png");
    public static final ResourceLocation WIDGET_INVENTORY = new ResourceLocation("textures/gui/frazionz/container/inventory_widget.png");
    protected static final ResourceLocation WIDGETS = new ResourceLocation("textures/gui/frazionz/widgets.png");
    ...
    public static Container inventorySlots;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        for (int i1 = 0; i1 < this.inventorySlots.inventorySlots.size(); ++i1)
        {
            ...
            if (this.isMouseOverSlot(slot, mouseX, mouseY) && slot.isEnabled())
            {
                ...
                this.drawTexturedModalRect(j1, k1, 0, 206, 16, 16);
                GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
                //this.drawRect(j1, k1, j1 + 16, k1 + 16, -2130706433);
    ...
    private void drawSlot(Slot slotIn)
    {
        ...
        if (!flag1)
        {
            if (flag)
            {
                GlStateManager.color(1.0F, 1.0F, 1.0F, 0.4F);
                this.mc.getTextureManager().bindTexture(WIDGETS);
                this.drawTexturedModalRect(i, j, 0, 206, 16, 16);
                GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
            }
    ...
    {
        /*if(keyCode == this.mc.gameSettings.saveItemRenderers.getKeyCode()) {
        	System.out.println("SAVE PRESSED");
        	Client.getInstance().saveItemRenderers();
        }*/
