...
{
    private static final ResourceLocation CRAFTING_TABLE_GUI_TEXTURES = new ResourceLocation("textures/gui/frazionz/container/crafting_table.png");
    ...
    public void initGui()
    {
        ...
        this.field_192049_w = new GuiButtonImage(10, this.guiLeft + 10, this.height / 2 - 49, 20, 18, 0, 212, 19, CRAFTING_TABLE_GUI_TEXTURES);
    ...
    {
        this.fontRendererObj.drawString(I18n.format("container.crafting"), (this.xSize / 2) - (this.fontRendererObj.getStringWidth(I18n.format("container.crafting")) / 2), 8, 16777215, true);
        this.fontRendererObj.drawString(I18n.format("container.inventory"), (this.xSize / 2) - (this.fontRendererObj.getStringWidth(I18n.format("container.inventory")) / 2), this.ySize - 118 + 2, 16777215, true);
    }
    ...
    protected void actionPerformed(GuiButton button, int mouseButton) throws IOException
    {
        if (button.id == 10)
        {
            ...
            this.guiLeft = this.field_192050_x.func_193011_a(this.field_193112_y, this.width, this.xSize);
            this.field_192049_w.func_191746_c(this.guiLeft + 10, this.height / 2 - 49);
        }
    }
