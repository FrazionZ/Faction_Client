...
public class GuiCrafting extends GuiContainer implements IRecipeShownListener
{
    ...
    public void initGui()
    {
        ...
        this.recipeButton = new GuiButtonImage(10, this.guiLeft + 10, this.height / 2 - 49, 20, 18, 0, 212, 19, CRAFTING_TABLE_GUI_TEXTURES);
    ...
    {
        this.fontRenderer.drawString(I18n.format("container.crafting"), (this.xSize / 2) - (this.fontRenderer.getStringWidth(I18n.format("container.crafting")) / 2), 6, 16777215, true);
        this.fontRenderer.drawString(I18n.format("container.inventory"), (this.xSize / 2) - (this.fontRenderer.getStringWidth(I18n.format("container.inventory")) / 2), this.ySize - 96 + 2, 16777215, true);
    }
    ...
    protected void actionPerformed(GuiButton button, int mouseButton) throws IOException
    {
        if (button.id == 10)
        {
            ...
            this.guiLeft = this.recipeBookGui.updateScreenPosition(this.widthTooNarrow, this.width, this.xSize);
            this.recipeButton.setPosition(this.guiLeft + 10, this.height / 2 - 49);
        }
    }
