...
{
    private static final ResourceLocation FURNACE_GUI_TEXTURES = new ResourceLocation("textures/gui/frazionz/container/furnace/onyx_furnace.png");

    /** The player inventory bound to this GUI. */
    private final InventoryPlayer playerInventory;
    private final IInventory tileFurnace;

    public GuiOnyxFurnace(InventoryPlayer playerInv, IInventory furnaceInv)
    {
        super(new ContainerOnyxFurnace(playerInv, furnaceInv));
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
    {
        ...
        if (TileEntityOnyxFurnace.isBurning(this.tileFurnace))
        {
