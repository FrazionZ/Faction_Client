...
public class GuiYelliteFurnace extends GuiContainer
{
    private static final ResourceLocation FURNACE_GUI_TEXTURES = new ResourceLocation("textures/gui/frazionz/container/furnace/yellite_furnace.png");

    /** The player inventory bound to this GUI. */
    private final InventoryPlayer playerInventory;
    private final IInventory tileFurnace;

    public GuiYelliteFurnace(InventoryPlayer playerInv, IInventory furnaceInv)
    {
        super(new ContainerZFurnace(playerInv, furnaceInv));
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
    {
        ...
        if (TileEntityZFurnace.isBurning(this.tileFurnace))
        {
