...
public class GuiToast extends Gui
{
    ...
    public float xAnimate = 160.0F;
    public int hAnimate = 32;

    public float getxAnimate() {
        return this.xAnimate;
    }

    public void setxAnimate(float xAnimate) {
    ...
    class ToastInstance<T extends IToast>
    {
        ...
        public boolean func_193684_a(int p_193684_1_, int p_193684_2_)
        {
            ...
            GlStateManager.translate((float)p_193684_1_ - xAnimate * this.func_193686_a(i), (float)(p_193684_2_ * hAnimate), (float)(500 + p_193684_2_));
