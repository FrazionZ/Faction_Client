...
public class BlockModelShapes
{
    ...
    public TextureAtlasSprite getTexture(IBlockState state)
    {
        ...
        {
            if (block == Blocks.WALL_SIGN || block == Blocks.HDV_CHEST || block == Blocks.STANDING_SIGN || block == Blocks.CHEST || block == Blocks.TRAPPED_CHEST || block == Blocks.STANDING_BANNER || block == Blocks.WALL_BANNER || block == Blocks.BED)
            {
                return this.modelManager.getTextureMap().getAtlasSprite("minecraft:blocks/planks_oak");
            }
            
            if( block == Blocks.DIRT_CHEST) {
            	return this.modelManager.getTextureMap().getAtlasSprite("minecraft:blocks/dirt");
            }
    ...
    {
        this.registerBuiltInBlocks(Blocks.DIRT_CHEST, Blocks.BAUXITE_CHEST, Blocks.FRAZION_CHEST, Blocks.HDV_CHEST, Blocks.YELLITE_CHEST, Blocks.ONYX_CHEST, Blocks.AIR, Blocks.FLOWING_WATER, Blocks.WATER, Blocks.FLOWING_LAVA, Blocks.LAVA, Blocks.PISTON_EXTENSION, Blocks.CHEST, Blocks.ENDER_CHEST, Blocks.TRAPPED_CHEST, Blocks.STANDING_SIGN, Blocks.SKULL, Blocks.END_PORTAL, Blocks.BARRIER, Blocks.WALL_SIGN, Blocks.WALL_BANNER, Blocks.STANDING_BANNER, Blocks.END_GATEWAY, Blocks.STRUCTURE_VOID, Blocks.WHITE_SHULKER_BOX, Blocks.ORANGE_SHULKER_BOX, Blocks.MAGENTA_SHULKER_BOX, Blocks.LIGHT_BLUE_SHULKER_BOX, Blocks.YELLOW_SHULKER_BOX, Blocks.LIME_SHULKER_BOX, Blocks.PINK_SHULKER_BOX, Blocks.GRAY_SHULKER_BOX, Blocks.SILVER_SHULKER_BOX, Blocks.CYAN_SHULKER_BOX, Blocks.PURPLE_SHULKER_BOX, Blocks.BLUE_SHULKER_BOX, Blocks.BROWN_SHULKER_BOX, Blocks.GREEN_SHULKER_BOX, Blocks.RED_SHULKER_BOX, Blocks.BLACK_SHULKER_BOX, Blocks.BED);
        ...
        this.registerBlockWithStateMapper(Blocks.NETHERRACK, (new StateMap.Builder()).withName(BlockNetherrack.VARIANT).build());
        this.registerBlockWithStateMapper(Blocks.Z_HOPPER, (new StateMap.Builder()).ignore(BlockZHopper.ENABLED).build());
        this.registerBlockWithStateMapper(Blocks.Z_TNT, (new StateMap.Builder()).ignore(BlockZTNT.EXPLODE).build());
        this.registerBlockWithStateMapper(Blocks.NETHER_WART_BLOCK2, (new StateMap.Builder()).withName(BlockMoreNWBVariant.VARIANT).build());
        this.registerBlockWithStateMapper(Blocks.SANDSTONE2, (new StateMap.Builder()).withName(BlockMoreSandstoneVariant.VARIANT).build());
        this.registerBlockWithStateMapper(Blocks.STONE_ANDESITE, (new StateMap.Builder()).withName(BlockMoreAndesiteVariant.VARIANT).build());
        this.registerBlockWithStateMapper(Blocks.STONE_ANDESITE_SMOOTH, (new StateMap.Builder()).withName(BlockMoreAndesiteSmoothVariant.VARIANT).build());
        this.registerBlockWithStateMapper(Blocks.STONE_GRANITE, (new StateMap.Builder()).withName(BlockMoreGraniteVariant.VARIANT).build());
        this.registerBlockWithStateMapper(Blocks.STONE_GRANITE_SMOOTH, (new StateMap.Builder()).withName(BlockMoreGraniteSmoothVariant.VARIANT).build());
        this.registerBlockWithStateMapper(Blocks.STONE_DIORITE, (new StateMap.Builder()).withName(BlockMoreDioriteVariant.VARIANT).build());
        this.registerBlockWithStateMapper(Blocks.STONE_DIORITE_SMOOTH, (new StateMap.Builder()).withName(BlockMoreDioriteSmoothVariant.VARIANT).build());
        this.registerBlockWithStateMapper(Blocks.STONE_BLACKSTONE, (new StateMap.Builder()).withName(BlockDarkAndesite.VARIANT).build());
        this.registerBlockWithStateMapper(Blocks.STONE_BLACKSTONE_SMOOTH, (new StateMap.Builder()).withName(BlockSmoothDarkAndesite.VARIANT).build());
        this.registerBlockWithStateMapper(Blocks.TROPHY_FORGE, (new StateMap.Builder()).build());
