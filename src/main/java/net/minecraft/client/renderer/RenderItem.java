...
public class RenderItem implements IResourceManagerReloadListener
{
    ...
    protected void renderItemModel(ItemStack stack, IBakedModel bakedmodel, ItemCameraTransforms.TransformType transform, boolean leftHanded)
    {
        if (!stack.isEmpty())
        {
            ...
            this.renderItem(stack, bakedmodel, true);
    ...
    {
        this.renderItemModelIntoGUI(stack, x, y, this.getItemModelWithOverrides(stack, (World)null, (EntityLivingBase)null), true);
    }
	
	public void renderItemWithoutEffectIntoGUI(ItemStack stack, int x, int y)
    {
        this.renderItemModelIntoGUI(stack, x, y, this.getItemModelWithOverrides(stack, (World)null, (EntityLivingBase)null), false);
    }

    protected void renderItemModelIntoGUI(ItemStack stack, int x, int y, IBakedModel bakedmodel, boolean renderEffect)
    {
        ...
        this.renderItem(stack, bakedmodel, renderEffect);
    ...
    public void renderItemAndEffectIntoGUI(@Nullable EntityLivingBase p_184391_1_, final ItemStack p_184391_2_, int p_184391_3_, int p_184391_4_)
    {
        if (!p_184391_2_.isEmpty())
        {
            ...
            try
            {
                this.renderItemModelIntoGUI(p_184391_2_, p_184391_3_, p_184391_4_, this.getItemModelWithOverrides(p_184391_2_, (World)null, p_184391_1_), true);
            }
    ...
    private void registerItems()
    {
        ...
        this.registerItem(Items.SKULL, 6, "skull_frazionz");
