...
public class TileEntityItemStackRenderer
{
    ...
    public void func_192838_a(ItemStack p_192838_1_, float p_192838_2_)
    {
        ...
        {
            TileEntityRendererDispatcher.instance.func_192855_a(this.dirt_chest, 0.0D, 0.0D, 0.0D, 0.0F, p_192838_2_);
        }
        else if (item == Item.getItemFromBlock(Blocks.YELLITE_CHEST))
        {
            TileEntityRendererDispatcher.instance.func_192855_a(this.yellite_chest, 0.0D, 0.0D, 0.0D, 0.0F, p_192838_2_);
        }
        else if (item == Item.getItemFromBlock(Blocks.BAUXITE_CHEST))
        {
            TileEntityRendererDispatcher.instance.func_192855_a(this.bauxite_chest, 0.0D, 0.0D, 0.0D, 0.0F, p_192838_2_);
        }
        else if (item == Item.getItemFromBlock(Blocks.FRAZION_CHEST))
        {
            TileEntityRendererDispatcher.instance.func_192855_a(this.frazion_chest, 0.0D, 0.0D, 0.0D, 0.0F, p_192838_2_);
        }
        else if (item == Item.getItemFromBlock(Blocks.HDV_CHEST))
        {
            TileEntityRendererDispatcher.instance.func_192855_a(this.hdv_chest, 0.0D, 0.0D, 0.0D, 0.0F, p_192838_2_);
        }
        else if (item == Item.getItemFromBlock(Blocks.ONYX_CHEST))
        {
            TileEntityRendererDispatcher.instance.func_192855_a(this.onyx_chest, 0.0D, 0.0D, 0.0D, 0.0F, p_192838_2_);
        }
