...
import fz.frazionz.client.renderer.tileentity.TileEntityItemCrusherRenderer;
import fz.frazionz.client.renderer.tileentity.TileEntityOnyxChestRenderer;
import fz.frazionz.client.renderer.tileentity.TileEntityTrophyForgeRenderer;
...
public class TileEntityRendererDispatcher
{
    ...
    private TileEntityRendererDispatcher()
    {
        ...
        this.renderers.put(TileEntityDirtChest.class, new TileEntityDirtChestRenderer());
