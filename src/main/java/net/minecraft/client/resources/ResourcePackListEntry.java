...
public abstract class ResourcePackListEntry implements GuiListExtended.IGuiListEntry
{
    ...
    public void func_192634_a(int p_192634_1_, int p_192634_2_, int p_192634_3_, int p_192634_4_, int p_192634_5_, int p_192634_6_, int p_192634_7_, boolean p_192634_8_, float p_192634_9_)
    {
        ...
        if(StringUtils.containsIgnoreCase(s, "X-RAY") || StringUtils.containsIgnoreCase(s, "XRAY") || StringUtils.containsIgnoreCase(s, "X RAY")) {
        ...
        if(StringUtils.containsIgnoreCase(s1, "X-RAY") || StringUtils.containsIgnoreCase(s1, "XRAY") || StringUtils.containsIgnoreCase(s1, "X RAY")) {
