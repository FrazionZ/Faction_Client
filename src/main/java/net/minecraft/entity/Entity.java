    ...
    public void moveEntity(MoverType x, double p_70091_2_, double p_70091_4_, double p_70091_6_)
    {
        ...
        else
        {
            ...
            if ((x == MoverType.SELF || x == MoverType.PLAYER) && this.onGround && this.isSneaking() && this instanceof EntityPlayer)
            {
            	...
            	if (this instanceof EntityPlayer && (x == MoverType.SELF || x == MoverType.PLAYER) && this.onGround && this.isSneaking()) {
                    double double4 = 0.05D;
                    double double5 = 0.05D;
                    final double double6 = 0.05;
                    while (double4 != 0.0 && this.world.checkNoEntityCollision(this.getEntityBoundingBox().offset(double4, -this.stepHeight, 0.0))) {
                    ...
                    while (double5 != 0.0 && this.world.checkNoEntityCollision(this.getEntityBoundingBox().offset(0.0, -this.stepHeight, double5))) {
                    ...
                    while (double4 != 0.0 && double5 != 0.0 && this.world.checkNoEntityCollision(this.getEntityBoundingBox().offset(double4, -this.stepHeight, double5))) {
                        if (double4 < 0.05 && double4 >= -0.05) {
                            double4 = 0.0;
                        }
                        else if (double4 > 0.0) {
