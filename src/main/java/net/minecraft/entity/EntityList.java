...
public class EntityList
{
    ...
    public static void init()
    {
        ...
        func_191303_a(211, "nether_spider", EntityNetherSpider.class, "nether_spider");
        func_191303_a(212, "big_xp", EntityBigXp.class, "big_xp");
        func_191303_a(213, "dynamite", EntityDynamite.class, "dynamite");
        func_191303_a(214, "dyamite_arrow", EntityDynamiteArrow.class, "dyamite_arrow");
        func_191303_a(215, "illager", EntityIllager.class, "illager");
        func_191303_a(216, "herobrine_1", EntityHerobrine1.class, "herobrine_1");
        func_191303_a(217, "z_tnt", EntityZTNTPrimed.class, "PrimedZTnt");
        func_191303_a(218, "demonz", EntityDemonZ.class, "demonz");
        func_191303_a(219, "demon_golem", EntityDemonGolem.class, "demon_golem");
        ...
        func_191305_a("nether_spider", 3419431, 11013646);
        func_191305_a("illager", 3419431, 11013646);
        func_191305_a("herobrine_1", 16756237, 2829099);    
        // SPAWN EGG func_191305_a("demonz", 3158064, 4004608);
        // SPAWN EGG func_191305_a("demon_golem", 1315860, 8388608);    
