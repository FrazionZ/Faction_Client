...
public class EntityList
{
    ...
    public static void init()
    {
        ...
        register(211, "nether_spider", EntityNetherSpider.class, "nether_spider");
        register(212, "big_xp", EntityBigXp.class, "big_xp");
        register(213, "dynamite", EntityDynamite.class, "dynamite");
        register(214, "dyamite_arrow", EntityDynamiteArrow.class, "dyamite_arrow");
        register(215, "illager", EntityIllager.class, "illager");
        register(216, "herobrine_1", EntityHerobrine1.class, "herobrine_1");
        register(217, "z_tnt", EntityZTNTPrimed.class, "PrimedZTnt");
        register(218, "demonz", EntityDemonZ.class, "demonz");
        register(219, "demon_golem", EntityDemonGolem.class, "demon_golem");
        ...
        addSpawnInfo("nether_spider", 3419431, 11013646);
        addSpawnInfo("illager", 3419431, 11013646);
        addSpawnInfo("herobrine_1", 16756237, 2829099);    
        // SPAWN EGG addSpawnInfo("demonz", 3158064, 4004608);
        // SPAWN EGG addSpawnInfo("demon_golem", 1315860, 8388608);    
