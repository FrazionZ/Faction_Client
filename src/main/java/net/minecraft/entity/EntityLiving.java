...
public abstract class EntityLiving extends EntityLivingBase
{
    ...
    private final NonNullList<ItemStack> inventoryTrophy = NonNullList.<ItemStack>func_191197_a(3, ItemStack.field_190927_a);
    ...
    public Iterable<ItemStack> getTrophyInventoryList() {
		return this.inventoryTrophy;
	}
    ...
    public ItemStack getItemStackFromSlot(EntityEquipmentSlot slotIn)
    {
        switch (slotIn.getSlotType())
        {
            ...
            case TROPHY:
                return this.inventoryTrophy.get(slotIn.getIndex());
    ...
    public void setItemStackToSlot(EntityEquipmentSlot slotIn, ItemStack stack)
    {
        switch (slotIn.getSlotType())
        {
            ...
            case TROPHY:
                this.inventoryTrophy.set(slotIn.getIndex(), stack);
			default:
				break;
        }
    }
    ...
    public static Item getArmorByChance(EntityEquipmentSlot slotIn, int chance)
    {
        switch (slotIn)
        {
            case HEAD:
                ...
                {
                    return Items.ONYX_HELMET;
                }
                else if (chance == 8)
                {
                    return Items.FRAZION_HELMET;
                }
            ...
            case CHEST:
                ...
                {
                    return Items.YELLITE_CHESTPLATE;
                }
                else if (chance == 6)
                {
                ...
                {
                    return Items.ONYX_CHESTPLATE;
                }
                else if (chance == 8)
                {
                    return Items.FRAZION_CHESTPLATE;
                }
            ...
            case LEGS:
                ...
                {
                    return Items.ONYX_LEGGINGS;
                }
                else if (chance == 8)
                {
                    return Items.FRAZION_LEGGINGS;
                }
            ...
            case FEET:
                ...
                {
                    return Items.ONYX_BOOTS;
                }
                else if (chance == 8)
                {
                    return Items.FRAZION_BOOTS;
                }
