...
public class EntitySpawnPlacementRegistry
{
    ...
    static
    {
        ...
        ENTITY_PLACEMENTS.put(EntityNetherSpider.class, EntityLiving.SpawnPlacementType.ON_GROUND);
        ENTITY_PLACEMENTS.put(EntityIllager.class, EntityLiving.SpawnPlacementType.ON_GROUND);
        ENTITY_PLACEMENTS.put(EntityHerobrine1.class, EntityLiving.SpawnPlacementType.ON_GROUND);
        ENTITY_PLACEMENTS.put(EntityDemonZ.class, EntityLiving.SpawnPlacementType.ON_GROUND);
        ENTITY_PLACEMENTS.put(EntityDemonGolem.class, EntityLiving.SpawnPlacementType.ON_GROUND);
    }
}
