...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    {
        return this.isHandActive() && this.activeItemStack.getItem().getItemUseAction(this.activeItemStack) == EnumAction.BLOCK_SWORD;
    }
    ...
    {
        return MathHelper.clamp(0.0F + adjustTicks, 0.0F, 1.0F);
    }
    ...
    public float getDigSpeed(IBlockState state)
    {
        ...
        if (f > 1.0F)
        {
            ...
            if (i > 0 && !itemstack.func_190926_b() && itemstack.getItem() != Items.FRAZION_HAMMER)
            {
                f += (float)(i * i + 1);
            }
        }
            ...
            if (!targetEntity.hitByEntity(this))
            {
                ...
                if (f > 0.0F || f1 > 0.0F)
                {
                    ...
                    if (flag2)
                    {
                        ...
                        if (targetEntity instanceof EntityLivingBase)
                        {
                            this.addStat(StatList.DAMAGE_DEALT, Math.round(f * 10.0F));
    ...
    public void enchantDone(ItemStack p_192024_1_, int p_192024_2_)
    {
    ...
    public ItemStack getItemStackFromSlot(EntityEquipmentSlot slotIn)
    {
        ...
        else if (slotIn == EntityEquipmentSlot.OFFHAND)
        {
        	...
        	return (ItemStack)this.inventory.armorInventory.get(slotIn.getIndex());
        }
        else if(slotIn.getSlotType() == EntityEquipmentSlot.Type.TROPHY) {
        	return (ItemStack)this.inventory.trophyInventory.get(slotIn.getIndex());
        }
        else
        {
    ...
    public void setItemStackToSlot(EntityEquipmentSlot slotIn, ItemStack stack)
    {
        ...
        {
            this.playEquipSound(stack);
            this.inventory.trophyInventory.set(slotIn.getIndex(), stack);
        }
    }
    ...
    {
    	ItemStack handItem = this.getHeldItemMainhand();
