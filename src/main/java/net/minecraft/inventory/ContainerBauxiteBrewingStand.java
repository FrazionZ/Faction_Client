...
public class ContainerBauxiteBrewingStand extends Container
{
    ...
    public ContainerBauxiteBrewingStand(InventoryPlayer playerInventory, IInventory tileBrewingStandIn)
    {
        this.tileBrewingStand = tileBrewingStandIn;
        this.addSlotToContainer(new ContainerBauxiteBrewingStand.Potion(tileBrewingStandIn, 0, 61, 73));
        this.addSlotToContainer(new ContainerBauxiteBrewingStand.Potion(tileBrewingStandIn, 1, 84, 80));
        this.addSlotToContainer(new ContainerBauxiteBrewingStand.Potion(tileBrewingStandIn, 2, 107, 73));
        this.addSlotToContainer(new ContainerBauxiteBrewingStand.Potion(tileBrewingStandIn, 3, 107, 90));
        this.theSlot = this.addSlotToContainer(new ContainerBauxiteBrewingStand.Ingredient(tileBrewingStandIn, 4, 84, 39));
        this.addSlotToContainer(new ContainerBauxiteBrewingStand.Fuel(tileBrewingStandIn, 5, 22, 39));
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            if ((index < 0 || index > 3) && index != 4 && index != 5)
            {
                ...
                else if (ContainerBauxiteBrewingStand.Potion.canHoldPotion(itemstack) && (itemstack.func_190916_E() == 1) || (itemstack.func_190916_E() == 2))
                {
                ...
                else if (ContainerBauxiteBrewingStand.Fuel.isValidBrewingFuel(itemstack))
                {
