...
public class ContainerBauxiteFurnace extends Container
{
    ...
    public ContainerBauxiteFurnace(InventoryPlayer playerInventory, IInventory furnaceInventory)
    {
        ...
        this.addSlotToContainer(new SlotZFurnaceOutput(playerInventory.player, furnaceInventory, 4, 112, 54));
        this.addSlotToContainer(new SlotZFurnaceOutput(playerInventory.player, furnaceInventory, 5, 130, 54));
        this.addSlotToContainer(new SlotZFurnaceOutput(playerInventory.player, furnaceInventory, 6, 148, 54));
