...
public class ContainerFurnace extends Container
{
    ...
    public ContainerFurnace(InventoryPlayer playerInventory, IInventory furnaceInventory)
    {
        ...
        this.addSlotToContainer(new Slot(furnaceInventory, 0, 44, 14));
        this.addSlotToContainer(new SlotFurnaceFuel(furnaceInventory, 1, 44, 50));
        this.addSlotToContainer(new SlotFurnaceOutput(playerInventory.player, furnaceInventory, 2, 116, 32));
