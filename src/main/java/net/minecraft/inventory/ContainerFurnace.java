...
public class ContainerFurnace extends Container
{
    ...
    public ContainerFurnace(InventoryPlayer playerInventory, IInventory furnaceInventory)
    {
        ...
        this.addSlotToContainer(new Slot(furnaceInventory, 0, 49, 36));
        this.addSlotToContainer(new SlotFurnaceFuel(furnaceInventory, 1, 49, 72));
        this.addSlotToContainer(new SlotZFurnaceOutput(playerInventory.player, furnaceInventory, 2, 121, 54));
