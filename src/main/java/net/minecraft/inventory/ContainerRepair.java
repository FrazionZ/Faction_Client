...
public class ContainerRepair extends Container
{
    ...
    public ContainerRepair(InventoryPlayer playerInventory, final World worldIn, final BlockPos blockPosIn, EntityPlayer player)
    {
        ...
        this.addSlotToContainer(new Slot(this.inputSlots, 0, 32, 69));
        this.addSlotToContainer(new Slot(this.inputSlots, 1, 81, 69));
        this.addSlotToContainer(new Slot(this.outputSlot, 2, 139, 69)
        {
            ...
            public ItemStack func_190901_a(EntityPlayer p_190901_1_, ItemStack p_190901_2_)
            {
                ...
                if (ContainerRepair.this.materialCost > 0)
                {
                    ...
                    {
                        itemstack.substract(ContainerRepair.this.materialCost);
    ...
    public void updateRepairOutput()
    {
        ...
        else
        {
            ...
            if (k == i && k > 0 && this.maximumCost >= 100)
            {
                this.maximumCost = 99;
            }

            if (this.maximumCost >= 100 && !this.thePlayer.capabilities.isCreativeMode)
            {
                itemstack1 = ItemStack.field_190927_a;
            }
