...
public class ContainerWorkbench extends Container
{
    ...
    public ContainerWorkbench(InventoryPlayer playerInventory, World worldIn, BlockPos posIn)
    {
        ...
        this.addSlotToContainer(new SlotCrafting(playerInventory.player, this.craftMatrix, this.craftResult, 0, 129, 56));

        for (int i = 0; i < 3; ++i)
        {
            for (int j = 0; j < 3; ++j)
            {
                this.addSlotToContainer(new Slot(this.craftMatrix, j + i * 3, 35 + j * 18, 38 + i * 18));
            }
        }
        ...
        for (int k = 0; k < 3; ++k)
        {
            ...
            {
                this.addSlotToContainer(new Slot(playerInventory, i1 + k * 9 + 9, 13 + i1 * 18, 106 + k * 18));
            }
        }

        for (int l = 0; l < 9; ++l)
        {
            this.addSlotToContainer(new Slot(playerInventory, l, 13 + l * 18, 164));
        }
    }
