...
public class FzItemUltraBow extends Item
{
    public FzItemUltraBow()
    {
        this.maxStackSize = 1;
        ...
        this.addPropertyOverride(new ResourceLocation("pull"), new IItemPropertyGetter()
        {
            public float apply(ItemStack stack, @Nullable World worldIn, @Nullable EntityLivingBase entityIn)
            {
                ...
                {
                    return entityIn.getActiveItemStack().getItem() != Items.ULTRA_BOW ? 0.0F : (float)(stack.getMaxItemUseDuration() - entityIn.getItemInUseCount()) / 20.0F;
                }
            }
        });
    ...
    public void addInformation(ItemStack stack, @Nullable World playerIn, List<String> tooltip, ITooltipFlag advanced)
    {
    		...
    		tooltip.add(" ");
    		tooltip.add("\u00A76\u00bb \u00A7ePunch 3 de base");
    		tooltip.add("\u00A76\u00bb \u00A7eCet Arc ne peut avoir que Unbreaking");
    		tooltip.add(" ");
