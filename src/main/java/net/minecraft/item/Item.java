...
import fz.frazionz.manager.ItemManager;
...
public class Item
{
    ...
    public static void registerItems()
    {
        ...
        registerItemBlock(Blocks.NETHERRACK, (new ItemMultiTexture(Blocks.NETHERRACK, Blocks.NETHERRACK, new ItemMultiTexture.Mapper()
        {
            public String apply(ItemStack p_apply_1_)
            {
