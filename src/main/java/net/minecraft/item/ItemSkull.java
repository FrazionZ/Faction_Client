...
{
    private static final String[] SKULL_TYPES = new String[] {"skeleton", "wither", "zombie", "char", "creeper", "dragon", "frazionz"};
                ...
                else
                {
                    ...
                    if (tileentity instanceof TileEntitySkull)
                    {
                        ...
                        if (itemstack.getMetadata() == 3)
                        {
                            ...
                            tileentityskull.setPlayerProfile(gameprofile, 3);
                        }
                        else if (itemstack.getMetadata() == 6)
                        {
                            GameProfile gameprofile = null;
                            ...
                            tileentityskull.setPlayerProfile(gameprofile, 6);
                        }
                        else
                        {
    ...
    public String getItemStackDisplayName(ItemStack stack)
    {
        ...
        else if (stack.getMetadata() == 6 && stack.hasTagCompound())
        {
            if (stack.getTagCompound().hasKey("SkullOwner", 8))
            {
                return I18n.translateToLocalFormatted("item.skull.player.name", stack.getTagCompound().getString("SkullOwner"));
