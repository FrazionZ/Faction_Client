...
public class NetHandlerPlayServer implements INetHandlerPlayServer, ITickable
{
    ...
    public void processUseEntity(CPacketUseEntity packetIn)
    {
        ...
        if (entity != null)
        {
            ...
            if (this.playerEntity.getDistanceSqToEntity(entity) < d0)
            {
                ...
                {
                    if (entity instanceof EntityItem || entity instanceof EntityXPOrb || entity instanceof EntityDynamiteArrow || entity instanceof EntityArrow || entity == this.playerEntity)
                    {
    ...
    public void processStartTrophyForge(CPacketTrophyForge packetIn)
    {
        ...
        if(this.playerEntity.openContainer.windowId == packetIn.getWindowId() && this.playerEntity.openContainer.getCanCraft(this.playerEntity) && !this.playerEntity.isSpectator()) 
        {	
        	this.playerEntity.openContainer.startForging();
        	this.playerEntity.openContainer.detectAndSendChanges();
        }
    }
    ...
    public void processCreativeInventoryAction(CPacketCreativeInventoryAction packetIn)
    {
        ...
        if (this.playerEntity.interactionManager.isCreative())
        {
            ...
            ItemStack itemstack = packetIn.getStack();
                ...
                boolean flag1 = packetIn.getSlotId() >= 1 && packetIn.getSlotId() <= 48;
    ...
    public void processCustomPayload(CPacketCustomPayload packetIn)
    {
        ...
        {
            if (this.playerEntity.openContainer instanceof ContainerTrophyForge)
            {
                try
                {
                    PacketBuffer packetBuffer = packetIn.getBufferData();
                    ...
                    ContainerTrophyForge containerbeacon = (ContainerTrophyForge)this.playerEntity.openContainer;
