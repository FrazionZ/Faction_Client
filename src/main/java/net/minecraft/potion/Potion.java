...
public class Potion
{
    ...
    public static void registerPotions()
    {
        ...
        REGISTRY.register(5, new ResourceLocation("strength"), (new PotionAttackDamage(false, 9643043, 2.0D)).setPotionName("effect.damageBoost").setIconIndex(4, 0).registerPotionAttributeModifier(SharedMonsterAttributes.ATTACK_DAMAGE, "648D7064-6A60-4F59-8ABE-C2C23A6DD7A9", 0.0D, 0).setBeneficial());
        ...
        REGISTRY.register(28, new ResourceLocation("nofall"), (new Potion(false, 12624973)).setPotionName("effect.noFall").setIconIndex(3, 2).setBeneficial());
    }
}
