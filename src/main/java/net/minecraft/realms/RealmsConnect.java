        ...
        (new Thread("Realms-connect-task")
        {
            public void run()
            {
                ...
                try
                {
                    ...
                    RealmsConnect.this.connection.sendPacket(new CPacketLoginStart(Minecraft.getMinecraft().getSession().getProfile(), Minecraft.getMinecraft().getSession().getToken()));
                }
