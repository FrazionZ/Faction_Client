    ...
    public void run()
    {
        try
        {
            if (this.startServer())
            {
                ...
                //this.statusResponse.setVersion(new ServerStatusResponse.Version("1.12.2", 574200));
                this.statusResponse.setVersion(new ServerStatusResponse.Version("1.12.2", 1343));
