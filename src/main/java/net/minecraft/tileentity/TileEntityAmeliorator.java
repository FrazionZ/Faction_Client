...
import net.minecraft.item.crafting.AmelioratorRecipes;
...
public class TileEntityAmeliorator extends TileEntityLockable implements ITickable
{
    ...
    private NonNullList<ItemStack> AmelioratorItemStacks = NonNullList.<ItemStack>func_191197_a(10, ItemStack.field_190927_a);
    ...
    public void readFromNBT(NBTTagCompound compound)
    {
        ...
        this.AmelioratorItemStacks = NonNullList.<ItemStack>func_191197_a(this.getSizeInventory(), ItemStack.field_190927_a);
        ItemStackHelper.func_191283_b(compound, this.AmelioratorItemStacks);
    ...
    public NBTTagCompound writeToNBT(NBTTagCompound compound)
    {
        ...
        ItemStackHelper.func_191282_a(compound, this.AmelioratorItemStacks);
