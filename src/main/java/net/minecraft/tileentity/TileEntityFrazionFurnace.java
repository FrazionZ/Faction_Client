...
import net.minecraft.inventory.ContainerFrazionFurnace;
...
public class TileEntityFrazionFurnace extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    private NonNullList<ItemStack> furnaceItemStacks = NonNullList.<ItemStack>func_191197_a(13, ItemStack.field_190927_a);
    ...
    public void readFromNBT(NBTTagCompound compound)
    {
        ...
        this.currentItemBurnTime = getItemBurnTime(this.furnaceItemStacks.get(6));
    ...
    public void update()
    {
        ...
        if (!this.world.isRemote)
        {
            ...
            if ((this.isBurning() || (!itemstack.func_190926_b() && !((ItemStack)this.furnaceItemStacks.get(0)).func_190926_b()) || ( !itemstack.func_190926_b() && !((ItemStack)this.furnaceItemStacks.get(1)).func_190926_b()) || ( !itemstack.func_190926_b() && !((ItemStack)this.furnaceItemStacks.get(2)).func_190926_b()) || ( !itemstack.func_190926_b() && !((ItemStack)this.furnaceItemStacks.get(3)).func_190926_b() || ( !itemstack.func_190926_b() && !((ItemStack)this.furnaceItemStacks.get(4)).func_190926_b() || ( !itemstack.func_190926_b() && !((ItemStack)this.furnaceItemStacks.get(5)).func_190926_b())))))
            {
                    ...
                    if (this.isBurning())
                    {
                        ...
                        if (!itemstack.func_190926_b())
                        {
                            ...
                            if (itemstack.func_190926_b())
                            {
                                ...
                                this.furnaceItemStacks.set(6, item1 == null ? ItemStack.field_190927_a : new ItemStack(item1));
                            }
                        }
                    }
                }
    ...
    private boolean canSmelt()
    {
        ...
        else
        {
        	...
        	else if (itemstackD.func_190926_b() && !this.furnaceItemStacks.get(4).equals(ItemStack.field_190927_a))
            {
                return false;
            }
        	else if (itemstackE.func_190926_b() && !this.furnaceItemStacks.get(5).equals(ItemStack.field_190927_a))
            {
                return false;
            }
        	else if (itemstack.func_190926_b()  && itemstackA.func_190926_b() && itemstackB.func_190926_b() && itemstackC.func_190926_b() && itemstackD.func_190926_b() && itemstackE.func_190926_b())
            {
                return false;
            }
            else
            {
                ...
                if (itemstack1.func_190926_b() && itemstackA1.func_190926_b() && itemstackB1.func_190926_b() && itemstackC1.func_190926_b() && itemstackD1.func_190926_b() && itemstackE1.func_190926_b())
                {
                    return true;
                }
                ...
                else if (itemstackD1.func_190916_E() < this.getInventoryStackLimit() && itemstackD1.func_190916_E() < itemstackD1.getMaxStackSize())
                {
                    return true;
                }
                else if (itemstackE1.func_190916_E() < this.getInventoryStackLimit() && itemstackE1.func_190916_E() < itemstackE1.getMaxStackSize())
                {
                    return true;
                }
                else
