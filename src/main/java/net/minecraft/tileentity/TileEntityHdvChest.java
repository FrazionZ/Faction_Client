...
import net.minecraft.inventory.ContainerHdvChest;
...
public class TileEntityHdvChest extends TileEntityLockableLoot implements ITickable
{
    ...
    {
        return this.hasCustomName() ? this.field_190577_o : "";
    }

    public static void registerFixesChest(DataFixer fixer)
    {
        fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(TileEntityHdvChest.class, new String[] {"Items"}));
    }
    ...
    private void setNeighbor(TileEntityHdvChest chestTe, EnumFacing side)
    {
    ...
    public void update()
    {
        ...
        if (!this.world.isRemote && this.numPlayersUsing != 0 && (this.ticksSinceSync + i + j + k) % 200 == 0)
        {
            ...
            {
                if (entityplayer.openContainer instanceof ContainerHdvChest)
                {
                    IInventory iinventory = ((ContainerHdvChest)entityplayer.openContainer).getLowerChestInventory();
                }
            }
        }
    ...
    {
        if (!player.isSpectator() && this.getBlockType() instanceof BlockHdvChest)
        {
            --this.numPlayersUsing;
            this.world.addBlockEvent(this.pos, this.getBlockType(), 1, this.numPlayersUsing);
            this.world.notifyNeighborsOfStateChange(this.pos, this.getBlockType(), false);
    ...
    public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn)
    {
        ...
        return new ContainerHdvChest(playerInventory, this, playerIn);
    }
