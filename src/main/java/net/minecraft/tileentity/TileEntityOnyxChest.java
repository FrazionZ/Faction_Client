...
public class TileEntityOnyxChest extends TileEntityLockableLoot implements ITickable
{
    private NonNullList<ItemStack> chestContents = NonNullList.<ItemStack>func_191197_a(96, ItemStack.field_190927_a);
    ...
    {
        return this.hasCustomName() ? this.field_190577_o : "container.onyxchest";
    }

    public static void registerFixesChest(DataFixer fixer)
    {
        fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(TileEntityOnyxChest.class, new String[] {"Items"}));
    }
    ...
    public void update()
    {
        ...
        if (!this.world.isRemote && this.numPlayersUsing != 0 && (this.ticksSinceSync + i + j + k) % 200 == 0)
        {
            ...
            {
                if (entityplayer.openContainer instanceof ContainerOnyxChest)
                {
                    IInventory iinventory = ((ContainerOnyxChest)entityplayer.openContainer).getLowerChestInventory();
                }
            }
        }
    ...
    {
        if (!player.isSpectator() && this.getBlockType() instanceof BlockOnyxChest)
        {
            --this.numPlayersUsing;
            this.world.addBlockEvent(this.pos, this.getBlockType(), 1, this.numPlayersUsing);
            this.world.notifyNeighborsOfStateChange(this.pos, this.getBlockType(), false);
    ...
    public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn)
    {
        ...
        return new ContainerOnyxChest(playerInventory, this, playerIn);
    }
