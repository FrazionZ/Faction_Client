...
import net.minecraft.inventory.ContainerYelliteBrewingStand;
...
public class TileEntityYelliteBrewingStand extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    {
        return this.hasCustomName() ? this.customName : "container.yellite_brewing_stand";
    }
    ...
    public void update()
    {
        ...
        if (!this.world.isRemote)
        {
            ...
            if (!Arrays.equals(aboolean, this.filledSlots))
            {
                ...
                if (!(iblockstate.getBlock() instanceof BlockYelliteBrewingStand))
                {
                    return;
                }

                for (int i = 0; i < BlockYelliteBrewingStand.HAS_BOTTLE.length; ++i)
                {
                    iblockstate = iblockstate.withProperty(BlockYelliteBrewingStand.HAS_BOTTLE[i], Boolean.valueOf(aboolean[i]));
                }
    ...
    {
        fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(TileEntityYelliteBrewingStand.class, new String[] {"Items"}));
    }
    ...
    {
        return "minecraft:yellite_brewing_stand";
    }

    public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn)
    {
        return new ContainerYelliteBrewingStand(playerInventory, this);
    }
