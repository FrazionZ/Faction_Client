...
import net.minecraft.inventory.ContainerZFurnace;
...
public class TileEntityZFurnace extends TileEntityLockable implements ITickable, ISidedInventory
{
    private static final int[] SLOTS_TOP = new int[] {0, 1};
    private static final int[] SLOTS_BOTTOM = new int[] {2, 3, 4};
    private static final int[] SLOTS_SIDES = new int[] {2};
    private NonNullList<ItemStack> furnaceItemStacks = NonNullList.<ItemStack>func_191197_a(5, ItemStack.field_190927_a);
    ...
    {
        fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(TileEntityZFurnace.class, new String[] {"Items"}));
    }
    ...
    public void update()
    {
        ...
        if (!this.world.isRemote)
        {
            ...
            if ((this.isBurning() || (!itemstack.func_190926_b() && !((ItemStack)this.furnaceItemStacks.get(0)).func_190926_b()) || ( !itemstack.func_190926_b() && !((ItemStack)this.furnaceItemStacks.get(1)).func_190926_b())))
            {
                    ...
                    if (this.isBurning())
                    {
                        ...
                        if (!itemstack.func_190926_b())
                        {
                            ...
                            if (itemstack.func_190926_b())
                            {
                                ...
                                this.furnaceItemStacks.set(2, item1 == null ? ItemStack.field_190927_a : new ItemStack(item1));
                            }
                        }
                    }
                }
            ...
            {
                flag1 = true;
                BlockYelliteFurnace.setState(this.isBurning(), this.world, this.pos);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        else
        {
        	...
        	else if(itemstack.func_190926_b() && itemstackA.func_190926_b())
        	{
        		return false;
        	}
            else
            {	
                ...
                ItemStack itemstackA1 = this.furnaceItemStacks.get(4);

                if (itemstack1.func_190926_b())
                {
                    return true;
                }
                else if (!itemstack1.isItemEqual(itemstack) && !itemstackA1.isItemEqual(itemstackA))
                {
                    return false;
                }
    ...
    public void smeltItem()
    {
        if (this.canSmelt())
        {
            ...
            ItemStack itemstack2 = this.furnaceItemStacks.get(3);
            ItemStack itemstackA2 = this.furnaceItemStacks.get(4);
            ...
            {
                this.furnaceItemStacks.set(4, itemstackA1.copy());
    ...
    {
        return new ContainerZFurnace(playerInventory, this);
    }
