...
public class CombatTracker
{
    ...
    public void calculateFallSuffix()
    {
        ...
        if (this.fighter.isOnLadder())
        {
            ...
            else if (block == Blocks.BAUXITE_LADDER)
            {
                this.fallSuffix = "bauxite_ladder";
            }
            else if (block == Blocks.YELLITE_LADDER)
            {
                this.fallSuffix = "yellite_ladder";
            }
            else if (block == Blocks.ONYX_LADDER)
            {
                this.fallSuffix = "onyx_ladder";
            }
            else if (block == Blocks.FRAZION_LADDER)
            {
                this.fallSuffix = "frazion_ladder";
            }
