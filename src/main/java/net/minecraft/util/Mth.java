...
public class Mth {
   ...
   /*public static IntStream outFromOrigin(int p_216251_, int p_216252_, int p_216253_, int p_216254_) {
      if (p_216252_ > p_216253_) {
         throw new IllegalArgumentException("upperbound %d expected to be > lowerBound %d".formatted(p_216253_, p_216252_));
      } else if (p_216254_ < 1) {
         throw new IllegalArgumentException("steps expected to be >= 1, was %d".formatted(p_216254_));
      } else {
