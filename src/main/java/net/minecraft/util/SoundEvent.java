...
public class SoundEvent
{
    ...
    public static void registerSounds()
    {
        ...
        registerSound("record.fz1");
        registerSound("record.fz2");
        registerSound("record.fz3");
        registerSound("record.fz4");
        registerSound("record.fz5");
        registerSound("record.fz6");
        registerSound("record.fz7");
        registerSound("record.fz8");
        registerSound("record.fz9");
        registerSound("record.fz10");
    }
