...
public abstract class TabFzCompleter
{
    /** The {@link GuiTextField} that is backing this {@link TabFzCompleter} */
    ...
    public TabFzCompleter(GuiChatTextField textFieldIn, boolean hasTargetBlockIn)
    {
