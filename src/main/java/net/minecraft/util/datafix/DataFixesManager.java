...
public class DataFixesManager
{
    ...
    public static DataFixer createFixer()
    {
        ...
        TileEntityYelliteChest.registerFixesChest(datafixer);
        TileEntityOnyxChest.registerFixesChest(datafixer);
        TileEntityHdvChest.registerFixesChest(datafixer);
        ...
        EntityNetherSpider.registerFixesSpider(datafixer);
        EntityIllager.registerFixesIllager(datafixer);
        EntityHerobrine1.registerFixesHerobrine(datafixer);
