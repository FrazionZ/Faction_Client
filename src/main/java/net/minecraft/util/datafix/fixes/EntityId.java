...
public class EntityId implements IFixableData
{
    ...
    static
    {
        ...
        OLD_TO_NEW_ID_MAP.put("PrimedZTnt", "minecraft:z_tnt");
        OLD_TO_NEW_ID_MAP.put("nether_spider", "minecraft:nether_spider");
        OLD_TO_NEW_ID_MAP.put("big_xp", "minecraft:big_xp");
        
        OLD_TO_NEW_ID_MAP.put("illager", "minecraft:illager");
        
        OLD_TO_NEW_ID_MAP.put("dynamite", "minecraft:dynamite");
        OLD_TO_NEW_ID_MAP.put("dynamite_arrow", "minecraft:dynamite_arrow");
        
        OLD_TO_NEW_ID_MAP.put("herobrine_1", "minecraft:herobrine_1");
        OLD_TO_NEW_ID_MAP.put("demonz", "minecraft:demonz");
        OLD_TO_NEW_ID_MAP.put("demon_golem", "minecraft:demon_golem");
