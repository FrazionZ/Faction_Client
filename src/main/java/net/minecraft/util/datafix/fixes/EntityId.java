...
public class EntityId implements IFixableData
{
    ...
    static
    {
        ...
        field_191276_a.put("PrimedZTnt", "minecraft:z_tnt");
        field_191276_a.put("nether_spider", "minecraft:nether_spider");
        field_191276_a.put("big_xp", "minecraft:big_xp");
        
        field_191276_a.put("illager", "minecraft:illager");
        
        field_191276_a.put("dynamite", "minecraft:dynamite");
        field_191276_a.put("dynamite_arrow", "minecraft:dynamite_arrow");
        
        field_191276_a.put("herobrine_1", "minecraft:herobrine_1");
        field_191276_a.put("demonz", "minecraft:demonz");
        field_191276_a.put("demon_golem", "minecraft:demon_golem");
    }
}
