...
public class ItemIntIDToString implements IFixableData
{
    ...
    static
    {
        ...
        ID_MAP[462] = "minecraft:z_hopper";
        ID_MAP[463] = "minecraft:dirt_chest";
        ID_MAP[464] = "minecraft:yellite_chest";
        ID_MAP[465] = "minecraft:onyx_chest";
        ID_MAP[466] = "minecraft:hdv_chest";
        
        ID_MAP[480] = "minecraft:yellite_furnace";
        ID_MAP[481] = "minecraft:lit_yellite_furnace";
        ID_MAP[482] = "minecraft:bauxite_furnace";
        ID_MAP[483] = "minecraft:lit_bauxite_furnace";
        ID_MAP[484] = "minecraft:onyx_furnace";
        ID_MAP[485] = "minecraft:lit_onyx_furnace";
        ID_MAP[486] = "minecraft:frazion_furnace";
        ID_MAP[487] = "minecraft:lit_frazion_furnace";
        ID_MAP[488] = "minecraft:bauxite_ladder";
        
        ID_MAP[489] = "minecraft:crimson_log";
        ID_MAP[490] = "minecraft:crimson_roots";
        ID_MAP[491] = "minecraft:crimson_fungi";
        
        ID_MAP[492] = "minecraft:nether_wart_block2";
        ID_MAP[493] = "minecraft:sandstone2";
        ID_MAP[494] = "minecraft:stone_andesite";
        ID_MAP[495] = "minecraft:stone_andesite_smooth";
        ID_MAP[496] = "minecraft:stone_granite";
        ID_MAP[497] = "minecraft:stone_granite_smooth";
        ...
        ID_MAP[505] = "minecraft:bauxite_chest";
        ID_MAP[506] = "minecraft:frazion_chest";
        ID_MAP[507] = "minecraft:renforced_sand";
        
        ID_MAP[512] = "minecraft:wither_block";
        
        ID_MAP[513] = "minecraft:compact_cobblestone_x1";
        ID_MAP[514] = "minecraft:compact_cobblestone_x2";
        ID_MAP[515] = "minecraft:compact_cobblestone_x3";
        ID_MAP[516] = "minecraft:compact_cobblestone_x4";
        ID_MAP[517] = "minecraft:compact_cobblestone_x5";
        
        ID_MAP[518] = "minecraft:reverse_fall_block";
        
        ID_MAP[519] = "minecraft:stone_blackstone";
        ID_MAP[520] = "minecraft:stone_blackstone_smooth";
        ...
        ID_MAP[1002] = "minecraft:onyx";
        ID_MAP[1003] = "minecraft:z_powder";
        ID_MAP[1004] = "minecraft:frazion";
        
        ID_MAP[1005] = "minecraft:cosmic_powder";
        ID_MAP[1006] = "minecraft:cosmic_nugget";
        ID_MAP[1007] = "minecraft:cosmic_ingot";
        
        ID_MAP[1008] = "minecraft:yellite_helmet";
        ID_MAP[1009] = "minecraft:yellite_chestplate";
        ID_MAP[1010] = "minecraft:yellite_leggings";
        ID_MAP[1011] = "minecraft:yellite_boots";
        ID_MAP[1012] = "minecraft:yellite_sword";
        ID_MAP[1013] = "minecraft:yellite_shovel";
        ID_MAP[1014] = "minecraft:yellite_pickaxe";
        ID_MAP[1015] = "minecraft:yellite_axe";
        ID_MAP[1016] = "minecraft:yellite_hoe";
        
        ID_MAP[1017] = "minecraft:bauxite_helmet";
        ID_MAP[1018] = "minecraft:bauxite_chestplate";
        ID_MAP[1019] = "minecraft:bauxite_leggings";
        ID_MAP[1020] = "minecraft:bauxite_boots";
        ID_MAP[1021] = "minecraft:bauxite_sword";
        ID_MAP[1022] = "minecraft:bauxite_shovel";
        ID_MAP[1023] = "minecraft:bauxite_pickaxe";
        ID_MAP[1024] = "minecraft:bauxite_axe";
        ID_MAP[1025] = "minecraft:bauxite_hoe";
      
        ID_MAP[1026] = "minecraft:onyx_helmet";
        ID_MAP[1027] = "minecraft:onyx_chestplate";
        ID_MAP[1028] = "minecraft:onyx_leggings";
        ID_MAP[1029] = "minecraft:onyx_boots";
        ID_MAP[1030] = "minecraft:onyx_sword";
        ID_MAP[1031] = "minecraft:onyx_shovel";
        ID_MAP[1032] = "minecraft:onyx_pickaxe";
        ID_MAP[1033] = "minecraft:onyx_axe";
        ID_MAP[1034] = "minecraft:onyx_hoe";
        
        ID_MAP[1035] = "minecraft:frazion_helmet";
        ID_MAP[1036] = "minecraft:frazion_chestplate";
        ID_MAP[1037] = "minecraft:frazion_leggings";
        ID_MAP[1038] = "minecraft:frazion_boots";
        ID_MAP[1039] = "minecraft:frazion_sword";
        ID_MAP[1040] = "minecraft:frazion_shovel";
        ID_MAP[1041] = "minecraft:frazion_pickaxe";
        ID_MAP[1042] = "minecraft:frazion_axe";
        ID_MAP[1043] = "minecraft:frazion_hoe";
        
        ID_MAP[1044] = "minecraft:ultra_bow";
        
        ID_MAP[1045] = "minecraft:trophy_bat";
        ID_MAP[1046] = "minecraft:trophy_blaze";
        ID_MAP[1047] = "minecraft:trophy_creeper";
        ID_MAP[1048] = "minecraft:trophy_enderman";
        ID_MAP[1049] = "minecraft:trophy_ghast";
        ID_MAP[1050] = "minecraft:trophy_guardian";
        ID_MAP[1051] = "minecraft:trophy_villager";
        ID_MAP[1052] = "minecraft:trophy_shulker";
        ID_MAP[1053] = "minecraft:trophy_spider";
        ID_MAP[1054] = "minecraft:trophy_skeleton";
        ID_MAP[1055] = "minecraft:trophy_slime";
        ID_MAP[1056] = "minecraft:trophy_squid";
        
        ID_MAP[1060] = "minecraft:z_hammer";
        
        ID_MAP[1095] = "minecraft:big_xp";
        
        ID_MAP[1103] = "minecraft:frazion_helmet_70";
        ID_MAP[1104] = "minecraft:frazion_chestplate_70";
        ID_MAP[1105] = "minecraft:frazion_leggings_70";
        ID_MAP[1106] = "minecraft:frazion_boots_70";
        
        ID_MAP[1107] = "minecraft:frazion_helmet_100";
        ID_MAP[1108] = "minecraft:frazion_chestplate_100";
        ID_MAP[1109] = "minecraft:frazion_leggings_100";
        ID_MAP[1110] = "minecraft:frazion_boots_100";
        
        ID_MAP[1111] = "minecraft:travelers_helmet";
        ID_MAP[1112] = "minecraft:travelers_chestplate";
        ID_MAP[1113] = "minecraft:travelers_leggings";
        ID_MAP[1114] = "minecraft:travelers_boots";
        
        ID_MAP[1115] = "minecraft:legendary_axe";
        ID_MAP[1116] = "minecraft:legendary_sword";
        ID_MAP[1117] = "minecraft:frazion_dagger";
        ID_MAP[1125] = "minecraft:legendary_scythe";
        
        ID_MAP[1200] = "minecraft:dynamite";
        ID_MAP[1201] = "minecraft:dynamite_arrow";
    }
}
