...
public class TileEntityId implements IFixableData
{
    ...
    static
    {
        ...
        field_191275_a.put("z_hopper", "minecraft:z_hopper");
        field_191275_a.put("dirt_chest", "minecraft:dirt_chest");
        field_191275_a.put("hdv_chest", "minecraft:hdv_chest");
        field_191275_a.put("spawner_inventory", "minecraft:spawner_inventory");
        field_191275_a.put("onyx_chest", "minecraft:onyx_chest");
        field_191275_a.put("yellite_furnace", "minecraft:yellite_furnace");
        field_191275_a.put("bauxite_furnace", "minecraft:bauxite_furnace");
        field_191275_a.put("onyx_furnace", "minecraft:onyx_furnace");
        field_191275_a.put("frazion_furnace", "minecraft:frazion_furnace");
        field_191275_a.put("ameliorator", "minecraft:ameliorator");
        field_191275_a.put("yellite_brewing_stand", "minecraft:yellite_brewing_stand");
        field_191275_a.put("bauxite_brewing_stand", "minecraft:bauxite_brewing_stand");
        field_191275_a.put("onyx_brewing_stand", "minecraft:onyx_brewing_stand");
        field_191275_a.put("frazion_brewing_stand", "minecraft:frazion_brewing_stand");
        field_191275_a.put("trophy_forge", "minecraft:trophy_forge");
    }
}
