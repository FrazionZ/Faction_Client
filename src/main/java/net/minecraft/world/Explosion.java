...
public class Explosion
{
    ...
    public void doObsidianExplosion(IBlockState iblockstate, BlockPos blockpos)
    {
        if (iblockstate.getBlock() == Blocks.OBSIDIAN_FRAZION)
        {
            worldObj.setBlockState(blockpos, Blocks.AIR.getDefaultState(), 3);
        }
        else if (iblockstate.getBlock() == Blocks.OBSIDIAN_ONYX)
        {
        	worldObj.setBlockState(blockpos, Blocks.AIR.getDefaultState(), 3);
        }
        else if (iblockstate.getBlock() == Blocks.OBSIDIAN_BAUXITE)
        {
        	worldObj.setBlockState(blockpos, Blocks.AIR.getDefaultState(), 3);
        }
        else if (iblockstate.getBlock() == Blocks.OBSIDIAN_YELLITE)
        {
        	worldObj.setBlockState(blockpos, Blocks.AIR.getDefaultState(), 3);
        }
        else if (iblockstate.getBlock() == Blocks.OBSIDIAN)
        {
        	worldObj.setBlockState(blockpos, Blocks.AIR.getDefaultState(), 3);
        }
    }
    ...
    public void doExplosionB(boolean spawnParticles)
    {
        ...
        if (this.isSmoking)
        {
            for (BlockPos blockpos : this.affectedBlockPositions)
            {
                ...
                if (iblockstate.getMaterial() != Material.AIR && iblockstate.getBlock() != Blocks.COMPACT_COBBLESTONE_X4 && iblockstate.getBlock() != Blocks.BEDROCK && iblockstate.getBlock() != Blocks.COMPACT_COBBLESTONE_X5 && iblockstate.getBlock() != Blocks.OBSIDIAN_FRAZION && iblockstate.getBlock() != Blocks.OBSIDIAN_ONYX && iblockstate.getBlock() != Blocks.ENCHANTING_TABLE && iblockstate.getBlock() != Blocks.ENDER_CHEST)
                {
                	
                	if(iblockstate.getBlock() == Blocks.RENFORCED_SAND || iblockstate.getBlock() == Blocks.WITHER_BLOCK || iblockstate.getBlock() == Blocks.OBSIDIAN || iblockstate.getBlock() == Blocks.OBSIDIAN_YELLITE || iblockstate.getBlock() == Blocks.OBSIDIAN_BAUXITE)
                	{
                    	if(randomize < 0.08F && iblockstate.getBlock() == Blocks.OBSIDIAN) {
                    		doExplosionZebi(block, blockpos);
                    	}
                    	else if(randomize < 0.05F && (iblockstate.getBlock() == Blocks.WITHER_BLOCK || iblockstate.getBlock() == Blocks.OBSIDIAN_YELLITE)) {
                    		doExplosionZebi(block, blockpos);
                    	}
                    	else if(randomize < 0.02F && iblockstate.getBlock() == Blocks.OBSIDIAN_BAUXITE) {
                    		doExplosionZebi(block, blockpos);
                    	}
                    	
                    	else if(randomize < 0.2F && iblockstate.getBlock() == Blocks.COMPACT_COBBLESTONE_X3) {
                    		doExplosionZebi(block, blockpos);
                    	}
                    	
                    	else if(randomize < 0.3333f && iblockstate.getBlock() == Blocks.RENFORCED_SAND) {
                    		doExplosionZebi(block, blockpos);
                    	}
    ...
    public EntityLivingBase getExplosivePlacedBy()
    {
        ...
        else if (this.exploder instanceof EntityZTNTPrimed)
        {
            return ((EntityZTNTPrimed)this.exploder).getTntPlacedBy();
        }
        else
        {
    ...
    public void doExplosionZebi(Block block, BlockPos blockpos) {
		block.dropBlockAsItemWithChance(this.worldObj, blockpos, this.worldObj.getBlockState(blockpos), 1.0F / this.explosionSize, 0);
        this.worldObj.setBlockState(blockpos, Blocks.AIR.getDefaultState(), 3);
        block.onBlockDestroyedByExplosion(this.worldObj, blockpos, this);
    }
     ...
     * Does the second part of the explosion (sound, particles, drop spawn)
     */
    public void doZExplosionB(boolean spawnParticles)
    {
        ...
        if (this.isSmoking)
        {
            for (BlockPos blockpos : this.affectedBlockPositions)
            {
                ...
                if (iblockstate.getMaterial() != Material.AIR && iblockstate.getBlock() != Blocks.BEDROCK && iblockstate.getBlock() != Blocks.COMPACT_COBBLESTONE_X5)
                {
                	
                	if(iblockstate.getBlock() == Blocks.COMPACT_COBBLESTONE_X4 || iblockstate.getBlock() == Blocks.WITHER_BLOCK || iblockstate.getBlock() == Blocks.OBSIDIAN || iblockstate.getBlock() == Blocks.OBSIDIAN_YELLITE || iblockstate.getBlock() == Blocks.OBSIDIAN_BAUXITE || iblockstate.getBlock() == Blocks.OBSIDIAN_ONYX || iblockstate.getBlock() == Blocks.OBSIDIAN_FRAZION)
                	{
                		
                    	if(randomize < 0.05F && iblockstate.getBlock() == Blocks.OBSIDIAN_FRAZION) {
                    		doExplosionZebi(block, blockpos);
                    	}
                    	else if(randomize < 0.2F && iblockstate.getBlock() == Blocks.OBSIDIAN_ONYX) {
                    		doExplosionZebi(block, blockpos);
                    	}
                    	else if(randomize < 0.5F && iblockstate.getBlock() == Blocks.OBSIDIAN_BAUXITE) {
                    		doExplosionZebi(block, blockpos);
                    	}
                    	else if(randomize < 0.8F && iblockstate.getBlock() == Blocks.COMPACT_COBBLESTONE_X4) {
                    		doExplosionZebi(block, blockpos);
                    	}
                    	else if(iblockstate.getBlock() == Blocks.WITHER_BLOCK || iblockstate.getBlock() == Blocks.RENFORCED_SAND || iblockstate.getBlock() == Blocks.OBSIDIAN_YELLITE || iblockstate.getBlock() == Blocks.OBSIDIAN) {
                            doExplosionZebi(block, blockpos);
                    	}
                	}
