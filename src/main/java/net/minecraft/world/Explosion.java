...
public class Explosion
{
    ...
    public void doExplosionB(boolean spawnParticles) {
        this.doExplosionB(spawnParticles, ExplosiveType.TNT);
    }

    public void doExplosionB(boolean spawnParticles, ExplosiveType type)
    {
        ...
        if (this.damagesTerrain)
        {
            for (BlockPos blockpos : this.affectedBlockPositions)
            {
                ...
                if (iblockstate.getMaterial() != Material.AIR && iblockstate.getBlock() != Blocks.BEDROCK)
                {
    ...
    public void doExplosionC(Block block, BlockPos blockpos) {
        System.out.println("doExplosionC");
		block.dropBlockAsItemWithChance(this.world, blockpos, this.world.getBlockState(blockpos), 1.0F / this.size, 0);
        this.world.setBlockState(blockpos, Blocks.AIR.getDefaultState(), 3);
        block.onExplosionDestroy(this.world, blockpos, this);
    }
