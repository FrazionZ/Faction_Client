...
public class ChunkGeneratorHell implements IChunkGenerator
{
    ...
    private final WorldGenerator obsidianGen = new WorldGenObsidianNether(Blocks.OBSIDIAN.getDefaultState(), 100, BlockMatcher.forBlock(Blocks.LAVA) , BlockMatcher.forBlock(Blocks.AIR));
    ...
    private final WorldGenBush crimsonRoots = new WorldGenBush(Blocks.CRIMSON_ROOTS);
    private final WorldGenBush crimsonFungi = new WorldGenBush(Blocks.CRIMSON_FUNGI);
    ...
    public void buildSurfaces(int p_185937_1_, int p_185937_2_, ChunkPrimer primer)
    {
        ...
        for (int j = 0; j < 16; ++j)
        {
            for (int k = 0; k < 16; ++k)
            {
                ...
                int i1 = -1;
                IBlockState iblockstate = NETHERRACK_NYLIUM;
    ...
    public void populate(int x, int z)
    {
        ...
        {
            this.crimsonRoots.generate(this.world, this.rand, blockpos.add(this.rand.nextInt(16) + 8, this.rand.nextInt(128), this.rand.nextInt(16) + 8));
        }
        
        for (int o1 = 0; o1 < 2; ++o1)
        {
            this.crimsonFungi.generate(this.world, this.rand, blockpos.add(this.rand.nextInt(16) + 8, this.rand.nextInt(128), this.rand.nextInt(16) + 8));
        }
        ...
        if(rand.nextInt(100) <= 6) {
            ...
            for (int l = 0; l < 1; ++l)
            {
                this.obsidianGen.generate(this.world, this.rand, blockpos.add(this.rand.nextInt(16), i2 - 5 + this.rand.nextInt(6), this.rand.nextInt(16)));
            }
