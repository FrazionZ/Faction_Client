...
public abstract class WorldGenAbstractTree extends WorldGenerator
{
    ...
    protected boolean canGrowInto(Block blockType)
    {
        ...
        return material == Material.AIR || material == Material.LEAVES || blockType == Blocks.GRASS || blockType == Blocks.NETHERRACK.getStateFromMeta(1) || blockType == Blocks.DIRT || blockType == Blocks.LOG || blockType == Blocks.LOG2 || blockType == Blocks.SAPLING || blockType == Blocks.VINE;
    }
    ...
    {
        if (worldIn.getBlockState(pos).getBlock() != Blocks.DIRT && worldIn.getBlockState(pos).getBlock() != Blocks.NETHERRACK)
        {
