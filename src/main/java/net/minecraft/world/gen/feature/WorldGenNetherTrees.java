...
import net.minecraft.block.BlockNetherLog;
...
{
    private static final IBlockState DEFAULT_TRUNK = Blocks.CRIMSON_LOG.getStateFromMeta(1);
    private static final IBlockState DEFAULT_LEAF = Blocks.NETHER_WART_BLOCK.getDefaultState();
    ...
    {
        this(p_i2027_1_, 5, DEFAULT_TRUNK, DEFAULT_LEAF, false);
    }
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        if (position.getY() >= 1 && position.getY() + i + 1 <= 256)
        {
            ...
            else
            {
                ...
                if ((block == Blocks.GRASS || block == Blocks.DIRT || block == Blocks.FARMLAND || block == Blocks.NETHERRACK) && position.getY() < 256 - i - 1)
                {
