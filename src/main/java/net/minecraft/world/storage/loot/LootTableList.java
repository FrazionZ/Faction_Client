...
public class LootTableList
{
    ...
    public static final ResourceLocation ENTITIES_NETHER_SPIDER = register("entities/nether_spider");
    public static final ResourceLocation ENTITIES_COSMICKER = register("entities/cosmicker");
    public static final ResourceLocation BOSS_HEROBRINE_YELLOW = register("entities/herobrine_yellow");
    //public static final ResourceLocation BOSS_DEMONZ = register("entities/demonz");
