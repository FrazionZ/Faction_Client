...
public class CapeUtils
{
    ...
    public static void downloadCape(AbstractClientPlayer player)
    {
        ...
        {
            String s1 = "https://api.frazionz.net/capes/display?username=" + s;
            ...
            File cacheFile = new File(Minecraft.getMinecraft().gameDir, "assets/frazionz/capes/" + StringUtils.lowerCase(s));
