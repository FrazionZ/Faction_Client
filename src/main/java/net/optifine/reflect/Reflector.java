...
import fz.frazionz.client.renderer.tileentity.TileEntityBauxiteChestRenderer;
import fz.frazionz.client.renderer.tileentity.TileEntityDirtChestRenderer;
import fz.frazionz.client.renderer.tileentity.TileEntityFrazionChestRenderer;
import fz.frazionz.client.renderer.tileentity.TileEntityGrimoirePedestalRenderer;
import fz.frazionz.client.renderer.tileentity.TileEntityHdvChestRenderer;
import fz.frazionz.client.renderer.tileentity.TileEntityOnyxChestRenderer;
import fz.frazionz.client.renderer.tileentity.TileEntityYelliteChestRenderer;
...
public class Reflector
{
    ...
    public static ReflectorClass TileEntityDirtChestRenderer = new ReflectorClass(TileEntityDirtChestRenderer.class);
    public static ReflectorClass TileEntityYelliteChestRenderer = new ReflectorClass(TileEntityYelliteChestRenderer.class);
    public static ReflectorClass TileEntityBauxiteChestRenderer = new ReflectorClass(TileEntityBauxiteChestRenderer.class);
